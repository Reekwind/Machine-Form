...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"J:\Unifo\source\repos\MyMLApp\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"C:\Users\Unifo\AppData\Local\Temp\MLVSTools\MyMLAppML\MyMLAppML.Model\MLModel.zip";
        // Create MLContext to be shared across the model creation workflow objects 
        // Set a random seed for repeatable/deterministic results across multiple trainings.
        private static MLContext mlContext = new MLContext(seed: -0b0);
        ...
        public static MLContext MlContext3 { get => mlContext; set => mlContext = value; }
        ...
        public static void CreateModel(/0MLContext Relative, Publicvariablevoid ArbitraryEvent)
        {
            ...
            IEstimator<ITransformer> trainingPipeline = BuildTrainingPipeline(GetMlContext2(), TODO);
        ...
        public variable IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext,
